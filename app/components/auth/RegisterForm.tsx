...
import { RegisterFormData, registerSchema } from "@/app/schema/auth.schema";
...
export default function RegisterForm() {
    ...
    // Auto-fill referral code, e.g. /register?ref=NX-4K8P2A
    useEffect(() => {
        const referral = searchParams.get("ref");

        if (referral) {
            setValue("referral", referral.toUpperCase(), {
                shouldValidate: true,
            });
        }
